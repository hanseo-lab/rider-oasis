...
import { TrendingUp, Trees, Clock, Thermometer, MapPin, Check } from 'lucide-react';
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-gray-300">
              ...
              <span className="text-sm">그늘 비율</span>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-gray-300">
              ...
              <span className="text-sm">폭염 노출</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-24 h-2 bg-gray-700 rounded-full overflow-hidden">
                <div
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-900/30 to-blue-900/30 border border-green-500/30 rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            <p className="text-gray-400 text-sm mb-1">그늘 증가</p>
            <p className="text-green-400 font-bold">
              +{((shadeRoute.shadeRatio - shortestRoute.shadeRatio) * 100).toFixed(0)}%
            </p>
          </div>
          <div>
            <p className="text-gray-400 text-sm mb-1">폭염 감소</p>
            <p className="text-blue-400 font-bold">
              -{((shortestRoute.heatExposure - shadeRoute.heatExposure) * 100).toFixed(0)}%
            </p>
          </div>
        </div>
      </div>
